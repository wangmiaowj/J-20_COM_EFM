...
void ed_fm_set_draw_args(EdDrawArgument* drawargs, size_t size)
{
	...
	drawargs[290].f = s_airframe->getTopRotorClap();// 290 ist Top-Klappe Unten --ÉýÁ¦·çÉÈ
	drawargs[291].f = s_airframe->getWingNozzles();// 291 sind die FlügelDüsen --»úÒíÅç¿Ú
	drawargs[292].f = s_airframe->getTiltEngineNozzlePosition();// 292 ist die HeckDüse !!DAS STIMMT SO!! --Î²ÅçÏòÏÂÆ«×ª
...
{
	printf("Initialising...%s\n", cfg_path);//zur überprüfung des Initialisierungsprozesses
}
