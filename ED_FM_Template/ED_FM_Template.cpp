...
void ed_fm_set_draw_args_v2(float* data, size_t size)
{
	...
	data[290] = s_airframe->getTopRotorClap();// 290 ist Top-Klappe Unten --升力风扇
	data[291] = s_airframe->getWingNozzles();// 291 sind die Fl黦elD黶en --机翼喷口
	data[292] = s_airframe->getTiltEngineNozzlePosition();// 292 ist die HeckD黶e !!DAS STIMMT SO!! --尾喷向下偏转
