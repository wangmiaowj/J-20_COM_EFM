...
public:
	...
	//Engine Nozzle
	double setNozzlePosition(double dt); //verschoben nach Airframe CPP wegen der Gr鲞e
	double setNozzle2Position(double dt); //verschoben nach Airframe CPP wegen der Gr鲞e
	...
	//inline double getSightHorizontal();//vielleicht 黚erfl黶sig
	//inline double getSIghtVertical();//vielleicht 黚erfl黶sig
	*/
...
private:
	...
	//bool m_chuteSlewingZ = false;//neu eingef黦t zum Testenf黵 R點kkehr 0-Position
	...
	//-----------Speedo-Meter in kn und Mach und H鰄e-------------------------
	...
	*/
	...
	Actuator m_actuatorStab; //scheint nur zur optischen "Versch鰊erung" zu sein, aber egal
...
/*void Airframe::setFlapsPosition(double position) //ALT aber insges. funktionst點htig
{
...
// Neu eingef黦t den Lampen-Kram zur directen Steuerung der FC-3 Cockpit-Args
